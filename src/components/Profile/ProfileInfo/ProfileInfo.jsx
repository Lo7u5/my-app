        ...
        <div>
            ...
            <div className='grid mt-3 grid-cols-2 sm:grid-cols-4 lg:grid-cols-prGr'>
                {props.profile.photos.large ?
                    <img className='rounded-lg shadow-myBoxShadow h-28 sm:h-44 place-self-center' src={props.profile.photos.large} alt='ava' /> :
                    <img className='rounded-lg shadow-myBoxShadow h-28 sm:h-44 place-self-center'
                        src={profileAva}
                        alt='ava' />}
                <div className='text-myGray-darkIce sm:col-span-3 lg:col-auto grid'>
                    ...
                    <div className='sm:hidden'>
                        <button className='text-myGray-darkIce focus:outline-none' onClick={toggleMenu}>Contacts</button>
                        <ul id='contacts' className='hidden absolute bg-myGray-warmGray bg-opacity-75'>
