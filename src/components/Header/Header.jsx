    ...
    <header className='bg-myGray-warmGray bg-opacity-25 rounded-xl grid grid-flow-col sm:gap-4 sm:grid-cols-app lg:col-span-2'>
      ...
      <div className='hidden mr-4 sm:block lg:hidden sm:justify-self-end sm:self-center'>
        <nav className='inline-flex space-x-2'>
          <div className='pt-1.5'><NavLink className='text-myGray-darkIce' to='/profile' activeClassName='font-bold'>Profile</NavLink></div>
          ...
          <div className='pt-1.5'><NavLink className='text-myGray-darkIce' to='/users' activeClassName='font-bold'>Find Users</NavLink></div>
        </nav>
      </div>
      <div className='justify-self-end self-center mr-4 sm:hidden'>
        ...
        <ul id='nav' className='hidden absolute bg-myGray-warmGray bg-opacity-75 right-2.5'>
          ...
          <li className='pt-1.5'><NavLink className='text-myGray-darkIce' to='/news' activeClassName='font-bold'>News</NavLink></li>
          <li className='pt-1.5'><NavLink className='text-myGray-darkIce' to='/music' activeClassName='font-bold'>Music</NavLink></li>
